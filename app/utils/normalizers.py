...
def normalize_plan(raw_plan: Dict[str, Any]) -> Dict[str, Any]:
    ...
    - stops (list of objects):
      - place (Place object - normalized)
    ...
    for stop in stops:
        ...
        # Normalize the place in the stop
        ...
        normalized_stop = {
            ...
            "activity": stop.get("activity", "Visita"),
        }
    ...
    normalized = {
        ...
        "name": raw_plan.get("name", "Plan sin nombre"),
